                            ...
                            <div class="tab-pane fade" id="seo-meta" role="tabpanel" aria-labelledby="seo-meta-tab">
                                ...
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <input type="text" name="og_image_secure_url"
                            ...
                            <div class="tab-pane fade" id="article" role="tabpanel" aria-labelledby="seo-meta-tab">
                                ...
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <textarea name="image" class="form-control mycustom" rows="3">{{ isset($item->structuredData)
                                                ? $item->structuredData->image
                                                : '[
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-lg-12 fv-row">
                                            <textarea name="authors" class="form-control mycustom" rows="3">{{ isset($item->structuredData)
                                                ? $item->structuredData->authors
                                                : '[{
                                                                                            "@type": "Person",
                                                                                            "name": "Jane Doe",
